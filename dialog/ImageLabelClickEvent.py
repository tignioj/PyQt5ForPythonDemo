...
class myImgLabel(QtWidgets.QLabel):
    ...
    def mousePressEvent(self, event):
        ...
        elif QtCore.Qt.RightButton == event.buttons():  # right click
        ...
        elif event.buttons() == QtCore.Qt.LeftButton or QtCore.Qt.RightButton:  # Left and right buttons simultaneously pressed
        ...
        elif event.buttons() == QtCore.Qt.LeftButton or QtCore.Qt.MidButton:  # Left middle button simultaneously pressed
        ...
        elif event.buttons() == QtCore.Qt.MidButton or QtCore.Qt.RightButton:  #
        ...
        elif event.buttons() == QtCore.Qt.LeftButton or QtCore.Qt.MidButton or QtCore.Qt.RightButton:  # Left and right button simultaneously pressed
